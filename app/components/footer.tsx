...
export default function Footer() {
  return (
    <footer className="relative bg-[#050505] px-6 pt-20 pb-8 text-white md:px-10">

      <div className="mx-auto grid max-w-7xl gap-14 border-t border-white/10 pt-16 md:grid-cols-2 xl:grid-cols-4">
        ...
        <div>
          ...
          <div className="mt-8">
            ...
            <p className="text-lg font-semibold text-white transition hover:text-white/80">
              <a href="tel:+491778932219">
                +49 177 8932219
              </a>
            </p>
        ...
        <div>
          ...
          <div className="mt-6 flex flex-col gap-6 text-sm text-white/55">
        ...
        <div>
          ...
          <nav className="mt-6 grid grid-cols-2 gap-y-4 text-sm text-white/55 xl:flex xl:flex-col xl:gap-4">
        ...
        <div>
          ...
          <div className="mt-5 space-y-5 text-[15px] text-white/50">
            ...
            <div>
              ...
              <p>
                <a
                  href="mailto:contact@noviotechnologies.com"
          ...
          <div className="mt-5 flex gap-3">
            ...
            {/* Instagram */}
            <a
              href="https://www.instagram.com/noviotechnologies"
              target="_blank"
              rel="noopener noreferrer"
              className="flex h-11 w-11 items-center justify-center rounded-full bg-white/10 text-white transition duration-300 hover:scale-105 hover:bg-white/15"
            >
              <svg
