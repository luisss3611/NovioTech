        ...
        <div className="mx-auto max-w-7xl">
          <div className="max-w-5xl">
            ...
            <p className="mt-8 max-w-2xl text-lg leading-relaxed text-white/50">
              Schedule a free consultation with Novio Technologies and let’s
              create a digital presence that actually stands out.
            </p>
          </div>
          ...
          <section className="mt-36">
            ...
            <div className="mt-12 overflow-hidden rounded-[2rem] bg-white/[0.02]">
              <div
                id="my-cal-inline"
                style={{ height: "850px" }}
              />
